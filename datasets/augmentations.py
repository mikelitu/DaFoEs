...
class Compose(object):
    ...
    def __call__(self, images: List[np.ndarray], depths: List[np.ndarray], states: List[np.ndarray] = None, forces: List[np.ndarray] = None) -> List[torch.Tensor]:
...
class Normalize(object):
    ...
    def __call__(self, images: List[torch.Tensor], depths: List[torch.Tensor], states: List[np.ndarray] = None, forces: List[np.ndarray] = None) -> List[torch.Tensor]:
...
class RandomHorizontalFlip(object):
    ...
    def __call__(self, images: List[np.ndarray], depths: List[np.ndarray], states: List[np.ndarray] = None, forces: List[np.ndarray] = None) -> np.ndarray:
...
class CentreCrop(object):
    def __call__(self, images: List[np.ndarray], depths: List[np.ndarray], states: List[np.ndarray] = None, forces: List[np.ndarray] = None) -> List[np.ndarray]:
